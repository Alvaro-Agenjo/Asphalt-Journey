...
namespace eval ::optrace {
  variable script "C:/ALVARO/UPM/Cuarto de carrera/Primer cuatri/Sistemas electronicos digitales/3. Trabajo/VHDL/Asphalt-Journey/Asphalt-Journey.runs/synth_1/Logic_LED.tcl"
...
read_vhdl -library xil_defaultlib {{C:/ALVARO/UPM/Cuarto de carrera/Primer cuatri/Sistemas electronicos digitales/3. Trabajo/VHDL/Asphalt-Journey/Asphalt-Journey.srcs/sources_1/new/Logic_LED.vhd}}
...
synth_design -top Logic_LED -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef Logic_LED.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file Logic_LED_utilization_synth.rpt -pb Logic_LED_utilization_synth.pb"  } 
